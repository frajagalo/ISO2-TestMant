...
public class TestMovimientoCuenta extends TestCase {
	...
	private MovimientoCuenta movimientoCuentaPepe;
	...
	public void setUp() {
		...
		try {
			...
			this.movimientoCuentaPepe = new MovimientoCuenta(cuentaPepe, 100, "prueba");
			this.movimientoCuentaPepe.setId(1L);
		} catch (Exception e) {
	...
	public void testSetId() {
		this.movimientoCuentaPepe.setId(49L);
		assertEquals(this.movimientoCuentaPepe.getId(), Long.valueOf(49L));
	}

	@Test
	public void testSetCuenta() {
		this.movimientoCuentaPepe.setCuenta(this.cuentaPepe);
		assertEquals(this.movimientoCuentaPepe.getCuenta(), this.cuentaPepe);
	}
	
	@Test
	public void testConstructor() {
		MovimientoCuenta movimientoPrueba = new MovimientoCuenta(cuentaPepe, 100, "prueba");
	}

	@Test
	public void testGetImporte() {
		this.movimientoCuentaPepe.setImporte(100);
		assertEquals(this.movimientoCuentaPepe.getImporte(), Double.valueOf(100));
	}
	
	@Test
	public void testSetConcepto() {
		this.movimientoCuentaPepe.setConcepto("conceptoPrueba");
		assertEquals(this.movimientoCuentaPepe.getConcepto(), "conceptoPrueba");
	}
}
